...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260113105748_MdfySomething")]
    partial class MdfySomething
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Gaming.DrawAllowedTicketTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gaming_draw_allowed_ticket_templates");

                    b.HasIndex("TenantId", "DrawId", "TicketTemplateId")
                        .IsUnique()
                        .HasDatabaseName("ix_gaming_draw_allowed_ticket_templates_tenant_id_draw_id_ticket_");

                    b.ToTable("Gaming_DrawAllowedTicketTemplates", "public");
                });

            modelBuilder.Entity("Domain.Gaming.DrawPrizeMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gaming_draw_prize_mappings");

                    b.HasIndex("TenantId", "DrawId", "MatchCount", "PrizeId")
                        .IsUnique()
                        .HasDatabaseName("ix_gaming_draw_prize_mappings_tenant_id_draw_id_match_count_priz");

                    b.ToTable("Gaming_DrawPrizeMappings", "public");
                });
            ...
            modelBuilder.Entity("Domain.Gaming.PrizeAwardOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gaming_prize_award_options");

                    b.HasIndex("TenantId", "PrizeAwardId", "PrizeId")
                        .IsUnique()
                        .HasDatabaseName("ix_gaming_prize_award_options_tenant_id_prize_award_id_prize_id");

                    b.ToTable("Gaming_PrizeAwardOptions", "public");
                });
            ...
            modelBuilder.Entity("Domain.Gaming.Ticket", b =>
                {
                    ...
                    b.HasIndex("TenantId", "MemberId", "DrawId", "CreatedAt")
                        .HasDatabaseName("ix_gaming_tickets_tenant_id_member_id_draw_id_created_at");
            ...
            modelBuilder.Entity("Domain.Gaming.TicketTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_gaming_ticket_templates");

                    b.HasIndex("TenantId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_gaming_ticket_templates_tenant_id_code");

                    b.ToTable("Gaming_TicketTemplates", "public");
                });
