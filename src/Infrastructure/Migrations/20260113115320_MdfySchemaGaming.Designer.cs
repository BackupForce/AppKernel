...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260113115320_MdfySchemaGaming")]
    partial class MdfySchemaGaming
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Gaming.DrawPrizeMapping", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_draw_prize_mappings");

                    b.HasIndex("TenantId", "DrawId", "MatchCount", "PrizeId")
                        .IsUnique()
                        .HasDatabaseName("ix_draw_prize_mappings_tenant_id_draw_id_match_count_prize_id");

                    b.ToTable("draw_prize_mappings", "gaming");
                });
            ...
            modelBuilder.Entity("Domain.Gaming.PrizeAwardOption", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_prize_award_options");

                    b.HasIndex("TenantId", "PrizeAwardId", "PrizeId")
                        .IsUnique()
                        .HasDatabaseName("ix_prize_award_options_tenant_id_prize_award_id_prize_id");

                    b.ToTable("prize_award_options", "gaming");
                });
            ...
            modelBuilder.Entity("Domain.Gaming.PrizeRule", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_prize_rules");

                    b.HasIndex("TenantId", "GameType", "MatchCount", "IsActive")
                        .HasDatabaseName("ix_prize_rules_tenant_id_game_type_match_count_is_active");

                    b.ToTable("prize_rules", "gaming");
                });
