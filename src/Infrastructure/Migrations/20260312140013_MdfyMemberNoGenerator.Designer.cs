...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260312140013_MdfyMemberNoGenerator")]
    partial class MdfyMemberNoGenerator
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Admin.OperationLogs.AdminOperationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_admin_operation_logs");

                    b.HasIndex("DedupKey")
                        .IsUnique()
                        .HasDatabaseName("ix_admin_operation_logs_dedup_key");

                    b.HasIndex("TenantId", "OperatorUserId", "OccurredAtUtc")
                        .HasDatabaseName("ix_admin_operation_logs_tenant_id_operator_user_id_occurred_at");

                    b.HasIndex("TenantId", "TargetType", "TargetId", "OccurredAtUtc")
                        .HasDatabaseName("ix_admin_operation_logs_tenant_id_target_type_target_id_occurr");

                    b.ToTable("admin_operation_logs", "admin");
                });
            ...
            modelBuilder.Entity("Domain.Gaming.TicketClaimEvents.TicketClaimEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("PerMemberQuota")
                        .HasColumnType("integer")
                        .HasColumnName("per_member_quota");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ticket_claim_events");

                    b.HasIndex("TenantId", "Status", "StartsAtUtc", "EndsAtUtc")
                        .HasDatabaseName("ix_ticket_claim_events_tenant_id_status_starts_at_utc_ends_at_");

                    b.ToTable("ticket_claim_events", "gaming");
                });

            modelBuilder.Entity("Domain.Gaming.TicketClaimEvents.TicketClaimEventTagRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ticket_claim_event_tag_rules");
                    ...
                    b.ToTable("ticket_claim_event_tag_rules", "gaming");
                });

            modelBuilder.Entity("Domain.Gaming.TicketClaimEvents.TicketClaimMemberCounter", b =>
                {
                    b.Property<Guid>("EventId")
                        .HasColumnType("uuid")
                        .HasColumnName("event_id");
                    ...
                    b.HasKey("EventId", "MemberId")
                        .HasName("pk_ticket_claim_member_counters");

                    b.HasIndex("EventId", "MemberId")
                        .HasDatabaseName("ix_ticket_claim_member_counters_event_id_member_id");

                    b.ToTable("ticket_claim_member_counters", "gaming");
                });

            modelBuilder.Entity("Domain.Gaming.TicketClaimEvents.TicketClaimRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("IssuedTicketIds")
                        .HasColumnType("jsonb")
                        .HasColumnName("issued_ticket_ids");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ticket_claim_records");

                    b.HasIndex("TenantId", "EventId", "ClaimedAtUtc")
                        .HasDatabaseName("ix_ticket_claim_records_tenant_id_event_id_claimed_at_utc");

                    b.HasIndex("TenantId", "EventId", "MemberId", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ix_ticket_claim_records_tenant_id_event_id_member_id_idempoten");

                    b.ToTable("ticket_claim_records", "gaming");
                });
            ...
            modelBuilder.Entity("Domain.Members.MemberTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_member_tags_catalog");

                    b.HasIndex("TenantId", "IsActive")
                        .HasDatabaseName("ix_member_tags_catalog_tenant_id_is_active");

                    b.HasIndex("TenantId", "TagCode")
                        .IsUnique()
                        .HasDatabaseName("ux_member_tags_catalog_tenant_id_tag_code");

                    b.ToTable("member_tags_catalog", "public");
                });

            modelBuilder.Entity("Domain.Members.MemberTagBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_member_tag_bindings");
                    ...
                    b.HasIndex("TenantId", "MemberId", "TagId")
                        .IsUnique()
                        .HasDatabaseName("ux_member_tag_bindings_tenant_member_tag");

                    b.ToTable("member_tag_bindings", "public");
                });
