...
internal sealed class GetMemberAvailableTicketsForBetQueryHandler(
    IDbConnectionFactory dbConnectionFactory,
    IMemberRepository memberRepository,
    ITenantContext tenantContext,
    IDateTimeProvider dateTimeProvider)
    : IQueryHandler<GetMemberAvailableTicketsForBetQuery, AvailableTicketsResponse>
{
    ...
    public async Task<Result<AvailableTicketsResponse>> Handle(
        GetMemberAvailableTicketsForBetQuery request,
