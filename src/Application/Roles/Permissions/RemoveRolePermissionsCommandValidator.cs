...
internal sealed class RemoveRolePermissionsCommandValidator : AbstractValidator<RemoveRolePermissionsCommand>
{
    public RemoveRolePermissionsCommandValidator()
    {
