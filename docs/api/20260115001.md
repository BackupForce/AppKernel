...
- PrizeOption DTO 擴充派彩金額欄位（`PayoutAmount`），避免以成本欄位作為派彩。【F:src/Application/Gaming/Draws/PrizePool/PrizeOptionDto.cs†L1-L7】
...
|---|---|---|---|
| GET | `/games/{gameCode}/draws/{drawId:guid}/prize-pool` | `GetGameDrawPrizePool` | `Permission.GamingDraw.Settle` |
| PUT | `/games/{gameCode}/draws/{drawId:guid}/prize-pool` | `UpdateGameDrawPrizePool` | `Permission.GamingDraw.Settle` |
| GET | `/games/{gameCode}/draws/{drawId:guid}/prize-pool/validation` | `ValidateGameDrawPrizePool` | `Permission.GamingDraw.Settle` |
